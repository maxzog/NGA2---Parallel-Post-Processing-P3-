...
contains
    ...
    subroutine write_particle_data(particles, np, output_file)
        ...
        do i = 1, np
            write(20, '(I5, 3F10.3, 3F10.3, 3F10.3, 3F10.3)') particles(i)%id, &
...
program main
    ...
    npart = get_num_particles('particle.000050')

    ! Allocate particles array
    allocate(particles(npart))

    ! Read particle data from files
    call read_particle_data(npart, 'fld.000050', 'id.000050', 'particle.000050', 'uf.000050', 'vel.000050', particles)
